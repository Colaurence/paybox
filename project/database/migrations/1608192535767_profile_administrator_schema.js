...
class ProfileAdministratorSchema extends Schema {
  up () {
    this.create('profile_administrators', (table) => {
      table.increments()
  ...
  down () {
    this.drop('profile_administrators')
  }
}

module.exports = ProfileAdministratorSchema
